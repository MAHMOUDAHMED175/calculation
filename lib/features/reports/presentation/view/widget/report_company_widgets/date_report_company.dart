...
Widget dateReportCompany(
    BuildContext context, TextEditingController dateReportCompanyController) {
                  ...
                  child: defaultFormField(
                    taped: () {
                      ...
                      showDatePicker(
                        ...
                        dateReportCompanyController.text =
                            formatDate(value!, [yyyy, '-', mm, '-', dd]);
                        // ExpensesCubit.get(context).DateOfReportCompany(dateReportCompanyController.text);
                      });
                    },
                    readOnly: true,
                    hintText: "اضغط لاختيار تاريخ محدد",
                    prefix: Icons.date_range,
                    controller: dateReportCompanyController,
