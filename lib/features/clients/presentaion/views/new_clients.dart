                              ...
                              onPressed: () {
                                if (formKey.currentState!.validate()) {
                                  ClientsCubit.get(context)
                                      .InsertDatabaseClients(
                                      clientsName: nameClientsController.text,
                                      clientsAddress: addressPriceController.text,
                                      clientsPhone: phoneController.text,
                                      clientsNote: AddressController.text,
                                      money: moneyController.text,
                                  );
                                  Navigator.pop(context);

                                  // ClientsCubit.get(context).moneyStillClients(context);
